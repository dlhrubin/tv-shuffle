...
const successSearch = {
  ...
  config: {
    url: 'https://api.themoviedb.org/3/search/tv?', method: 'get', params: { api_key: config.KEY, query: 'how i met' }, headers: { Accept: 'application/json, text/plain, */*' }, transformRequest: [null], transformResponse: [null], timeout: 0, xsrfCookieName: 'XSRF-TOKEN', xsrfHeaderName: 'X-XSRF-TOKEN', maxContentLength: -1,
  },
  request: {},
};
