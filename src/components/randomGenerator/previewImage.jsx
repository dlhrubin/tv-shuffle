  ...
  const image = poster
    ...
    : (
      ...
      >
        <path
          style={{ fill: '#F7B239' }}
          d="M92.483,73.768c-1.617-3.948-2.506-8.273-2.506-12.8c0-18.621,15.091-33.725,33.725-33.725
        ...
        <polygon
          style={{ fill: '#F95428' }}
          points="448.418,148.211 381.561,148.211 130.425,148.211 63.569,148.211 63.138,148.211 108.14,512
                        159.717,512 352.256,512 403.847,512 448.849,148.211 "
        />
        <g>
          <path
            style={{ fill: '#F2F2F2' }}
            d="M381.561,148.211L352.256,512H292.15l3.665-120.994c19.847-12.989,21.41-106.024,3.597-119.283
                            l0.013-0.013l3.732-123.5H381.561z"
          />
          <path
            style={{ fill: '#F2F2F2' }}
            d="M216.185,391.02L219.837,512h-60.12l-29.292-363.789h78.417l3.732,123.486l0.013,0.013
                            C194.776,284.968,196.339,378.031,216.185,391.02z"
          />
        </g>
        <path
          style={{ fill: 'E09B2D' }}
          d="M189.489,73.768c-1.617-3.948-2.506-8.273-2.506-12.8c0-18.621,15.091-33.725,33.725-33.725
        ...
        <path
          style={{ fill: '#F7B239' }}
          d="M299.412,271.724c17.812,13.258,29.346,34.466,29.346,58.382c0,25.492-13.096,47.912-32.943,60.901
